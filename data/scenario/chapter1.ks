...
#tasky
おはようございます。現在時刻、午前7時00分。睡眠効率92%。良好です。[l][r]
...
#モノローグ
瞼の裏には、タスクリストのチェックボックスが焼き付いているようだ。[l][r]
...
#モノローグ
taskyの冷たい機械音声で、朝の微睡みは最悪の気分に変わった。[l][r]
...
#モノローグ
taskyに従ってストレッチを終えた。確かに体は軽いが、心臓の奥がチクリと痛む。[l][r]
...
#モノローグ
考えるのはやめよう。 taskyが最善の道を知っているはずだ 。[l][r]
...
#モノローグ
違う。これは僕自身の問題だ。研究だけは、 僕の意志で進めたい 。[l][r]
...
#tasky
警告：未登録の行動（Unknown Activity）を検知しました。[l][r]
...
#モノローグ
昼休み。同僚のミナはいつも通り、完璧に着こなしたスーツ姿で現れた。[l][r]
...
#ミナ
「あ、おはよう！ ねぇ、見てこれ！ 私、もう今日の達成率70%超えちゃった。[l][r]
...
#モノローグ
彼女はスマホの画面を突きつけてくる。そこには、僕より遥かに高いスコアが表示されていた。[l][r]
...
#モノローグ
その余裕と完璧さが、僕の焦燥感を油のように煽る。僕も彼女のようになりたい。[l][r]
...
#ミナ
「いいわ！ あなたも完璧を目指すべきよ。 負けたくないでしょう？[l][r]
...
[playse storage="mina/ふーん。...もっと頑張りなさい」.mp3" buf=1]
#ミナ
「え？ アルゴリズム？ ……そんなの考えたこともないわ。与えられたものをこなすだけよ。[l][r]
...
#tasky
競争モード起動：『昼休憩中の効率的な栄養補給』をミナ・Sとの間で競います。[l][r]
...
#tasky
新規タスク：「友人（カテゴリ：親密）との連絡」を認識しました。[l][r]
...
#モノローグ
taskyに肯定されると、現実の人間関係がどうでもいいノイズに思えてくる。[l][r]
...
#モノローグ
送信ボタンを押した瞬間、taskyが不満げな警告音を鳴らしている。[l][r]
[playse storage="narrator/これでよかったのか？ スコアが下がっている……と、常に頭の隅で計算している自分がいる。.mp3" buf=1]
これでよかったのか？ スコアが下がっている……と、常に頭の隅で計算している自分がいる。[l][r]
...
#モノローグ
既読がついたが、返信は来ない。友人は戸惑っているようだ。[l][r]
[playse storage="narrator/僕にはtaskyの報酬の方が重要だ……そう自分に言い聞かせるが、胸のつかえが取れない。.mp3" buf=1]
僕にはtaskyの報酬の方が重要だ……そう自分に言い聞かせるが、胸のつかえが取れない。[l][r]
...
#モノローグ
連絡を無視した。しかし、すぐにtaskyから「関係性維持の最適化」という新規タスクが提示された。[l][r]
...
#モノローグ
それでも、このタスクをクリアしなければ、僕の今日の「努力」は宙に浮いたままになる気がして、怖い。[l][r]
...
#モノローグ
疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、痺れるような快感が全身を駆け巡る。[l][r]
...
#モノローグ
taskyの通知が、まるで社会的な軽蔑の言葉のように響く。[l][r]
...
#モノローグ
更に次の報酬が欲しくなる。喉が渇いて海水を飲むようなものだ。[l][r]
この快感のループから抜け出せない。[p]
[jump target="*T1_5"]
...
#tasky
ご提案。休憩時間です。タスクリストに『自己投資：栄養補助食品の摂取』を追加しました。[l][r]
...
#モノローグ
本を開くが、内容が入ってこない。taskyの通知が頭の隅で鳴り始めている。[l][r]
