...
[stopse buf=1]
[playse storage="tasky/報酬予測：称号『パーフェクト・モーニング』および 10pt。.mp3" buf=1]
#tasky
報酬予測：称号『パーフェクト・モーニング』および10pt。[p]

; 2.1 朝のタスクと快感の選択 (T1-1)
[stopse buf=1]
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/タスク完了。...報酬『パーフェクト・モーニング』を付与しました。.mp3" buf=1]
#tasky
「タスク完了。素晴らしい反応速度です。[r]
...
; 主人公ボイス
[stopse buf=1]
[playse storage="narrator/違う。...僕はスマホを裏返し、震える手でノートを開いた.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
[playse storage="narrator/昼休み。...隙がないのだ。.mp3" buf=1]
#モノローグ
...
; ミナボイス
[stopse buf=1]
[playse storage="mina/あ、おはよう！ ねぇ、見てこれ！ 私、もう今日の達成率70%超えちゃった。すごいでしょ？ taskyは本当に便利だよね。使えば使うほど、自分が無敵になったような気がするの.mp3" buf=1]
#ミナ
「あ、おはよう！ ねぇ、見てこれ！[r]
