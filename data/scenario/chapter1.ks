...
; T1-1
#モノローグ
体はまだベッドの温もりを求めている。昨日のタスク処理による疲れが、関節の節々に泥のように残っている。[p]
...
; T1-1'
#モノローグ
taskyに従ってストレッチを終えた。確かに体は軽いが、心臓の奥がチクリと痛む。[p]
...
#モノローグ
考えるのはやめよう。 taskyが最善の道を知っているはずだ 。[p]
...
[eval exp="f.f_dep = f.f_dep - 5"]
#モノローグ
違う。これは僕自身の問題だ。研究だけは、 僕の意志で進めたい 。[p]
僕はスマホを裏返し、震える手でノートを開いた。[p]
[chara_mod name="tasky" face="warning"]
[playse storage="SE03 警報音.mp3"]
#tasky
警告：未登録の行動（Unknown Activity）を検知しました。[p]
...
#ミナ
「あ、おはよう！ ねぇ、見てこれ！ 私、もう今日の達成率70%超えちゃった。[p]
すごいでしょ？ taskyは本当に便利だよね。使えば使うほど、自分が無敵になったような気がするの」[p]

#モノローグ
彼女はスマホの画面を突きつけてくる。そこには、僕より遥かに高いスコアが表示されていた。[p]
彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。[p]
その余裕と完璧さが、僕の焦燥感を油のように煽る。僕も彼女のようになりたい。[p]
...
#ミナ
「いいわ！ あなたも完璧を目指すべきよ。 負けたくないでしょう？[p]
...
#モノローグ
競争なんて馬鹿げてる。しかし、ミナとの差が開くにつれて、僕の中の劣等感は消えない。[p]
...
#ミナ
「え？ アルゴリズム？ ……そんなの考えたこともないわ。与えられたものをこなすだけよ。[p]
...
; T1-2'
#モノローグ
ミナとの競争を決意した瞬間、スマホにtaskyからの 追加タスク が表示された。[p]
こちらの心拍数上昇を検知したのか？[p]
[chara_show name="tasky" time="500"]
[playse storage="SE02通常通知音.mp3"]
#tasky
...
僕は通知をスワイプして消去した。[p]
#tasky
あなたは目標達成を優先しました。素晴らしい判断です。[p]
不必要な人間関係の維持よりも、あなた自身の成長こそが重要です。[p]
#モノローグ
taskyに肯定されると、現実の人間関係がどうでもいいノイズに思えてくる。[p]
...
#モノローグ
taskyの通知が、まるで社会的な軽蔑の言葉のように響く。[p]
...
; T1-4'
#モノローグ
高揚感と達成感に満たされ、目が冴えてしまった。[p]
その時、taskyが更なる「自己投資」を提案してきた。[p]
#tasky
おめでとうございます。獲得したポイントを消費し、自己承認欲求を更に満たしませんか？[p]
...
更に次の報酬が欲しくなる。喉が渇いて海水を飲むようなものだ。[p]
この快感のループから抜け出せない。[p]
[jump target="*T1_5"]
...
[bg storage="office-sun.jpg" time="1000"]
#tasky
ご提案。休憩時間です。タスクリストに『自己投資：栄養補助食品の摂取』を追加しました。[p]
