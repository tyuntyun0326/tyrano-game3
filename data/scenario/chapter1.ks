...
それだけで、スコアは着実に上がっていく。自分の時間をどう使うか悩むという「コスト」がなくなったのだ。[r]
...
自己肯定感が満たされる感覚は、まるで脳内に直接ドーパミンを注入されたようだ。[r]
...
視線の先には、taskyをインストールする前に広げていた 卒業研究のノート がある。手つかずのままだ。[r]
...
AIが計算したルートに間違いはない。自分の個人的な目標なんて、どうせ非効率で、点数にもならない。[r]
今はスコアを稼ぐのが先決だ。[p]
...
以前はよく愚痴を言い合った仲だったが、最近の彼女はどこか違う。隙がないのだ。[r]
...
彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。[r]
...
#モノローグ
彼女の瞳が一瞬、曇ったように見えた。[r]
彼女の言葉は、このシステムの 本質的な部分 に疑問を持たせないよう、巧妙にプログラムされているかのようだ。[r]
...
今日は疲れているから、明日ゆっくり返信しようと思っていた。[r]
...
#モノローグ
疲労はピークだ。体は悲鳴を上げ、休息を求めている。眼球の奥がズキズキと痛み、視界が滲む。[r]
...
#モノローグ
画面が激しく明滅し、ファンファーレが鳴り響く。[r]
疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、痺れるような快感が全身を駆け巡る。[r]
この達成の光。この数値の上昇。これこそが、僕の存在証明だ。[r]
...
#モノローグ
指が勝手に動く。[r]
報酬を消費することで、空虚さが埋まるかと思ったが、逆だった。[r]
