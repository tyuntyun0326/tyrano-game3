...
; ナレーター
[stopse buf=1]
[playse storage="narrator/taskyを導入して数日。...ただ、画面に表示されるタスクをこなせばいい。.mp3" buf=1]
#モノローグ
taskyを導入して数日。生活は劇的に一変した。[r]
「何をすべきか」を考える必要がない。[r]
ただ、画面に表示されるタスクをこなせばいい。[p]

[stopse buf=1]
[playse storage="narrator/それだけで、スコアは着実に上がっていく。...自分の時間をどう使うか悩むという「コスト」がなくなったのだ。.mp3" buf=1]
#モノローグ
それだけで、スコアは着実に上がっていく。[r]
自分の時間をどう使うか悩むという「コスト」がなくなったのだ。[p]

[stopse buf=1]
[playse storage="narrator/毎朝、taskyの通知が僕の一日の始まりを告げる。...それは、単なるアラームではなく、僕が社会的に価値ある存在であることを保証してくれるファンファーレだ。.mp3" buf=1]
#モノローグ
毎朝、taskyの通知が僕の一日の始まりを告げる。[r]
それは、単なるアラームではなく、[r]
僕が社会的に価値ある存在であることを保証してくれるファンファーレだ。[p]
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/おはようございます。...完了してください。.mp3" buf=1]
#tasky
おはようございます。現在時刻、午前7時00分。睡眠効率92%。良好です。[r]
タスクリスト更新：『朝のストレッチと深呼吸』を認識しました。[r]
完了してください。[p]
...
; T1-1
[stopse buf=1]
[playse storage="narrator/体はまだベッドの温もりを求めている。...昨日のタスク処理による疲れが、関節の節々に泥のように残っている。.mp3" buf=1]
#モノローグ
体はまだベッドの温もりを求めている。[r]
昨日のタスク処理による疲れが、関節の節々に泥のように残っている。[p]

[stopse buf=1]
[playse storage="narrator/瞼の裏には、タスクリストのチェックボックスが焼き付いているようだ。... だが、taskyの通知は、無視できない親友からの呼びかけのように甘美で、強制的だ。.mp3" buf=1]
#モノローグ
瞼の裏には、タスクリストのチェックボックスが焼き付いているようだ。[r]
だが、taskyの通知は、無視できない親友からの呼びかけのように甘美で、強制的だ。[p]
...
[stopse buf=1]
[playse storage="narrator/僕はバネ仕掛けの人形のように跳ね起きた。...それだけで、一日の「優位性」が確保できる。.mp3" buf=1]
#モノローグ
僕はバネ仕掛けの人形のように跳ね起きた。[r]
思考停止のまま、指示通りに腕を伸ばし、深呼吸をする。[r]
たった5分。それだけで、一日の「優位性」が確保できる。[p]
; Taskyボイス
[stopse buf=1]
; ★リスト(tasky_new)一致
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/画面が黄金色に輝く。...自己肯定感が満たされる感覚は、まるで脳内に直接ドーパミンを注入されたようだ。.mp3" buf=1]
#モノローグ
画面が黄金色に輝く。この音、この光。即効的な快感。[r]
自己肯定感が満たされる感覚は、まるで脳内に直接ドーパミンを注入されたようだ。[p]
[stopse buf=1]
[playse storage="narrator/気持ちいい。...また明日もこれをやりたい、と無意識に渇望してしまう。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/「あと5分だけ…」と目を閉じた瞬間、スマホが怒ったように激しく振動した。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
[playse storage="narrator/taskyの冷たい機械音声で、朝の微睡みは最悪の気分に変わった。...まるで、怠惰な自分を全世界に晒されたような屈辱感。.mp3" buf=1]
#モノローグ
...
視線の先には、taskyをインストールする前に広げていた 卒業研究のノート がある。[r]
手つかずのままだ。[p]
[stopse buf=1]
[playse storage="narrator/taskyのリストに「卒研」は入っていない。...これをやらずに、本当に社会的な成功があるのだろうか。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
[playse storage="narrator/考えるのはやめよう。...自分の個人的な目標なんて、どうせ非効率で、点数にもならない。.mp3" buf=1]
#モノローグ
考えるのはやめよう。 taskyが最善の道を知っているはずだ 。[r]
AIが計算したルートに間違いはない。[r]
自分の個人的な目標なんて、どうせ非効率で、点数にもならない。[p]
[stopse buf=1]
[playse storage="narrator/今はスコアを稼ぐのが先決だ。.mp3" buf=1]
#モノローグ
今はスコアを稼ぐのが先決だ。[p]
...
[stopse buf=1]
; ★リスト(hero_new)一致
[playse storage="hero/違う。...僕はスマホを裏返し、震える手でノートを開いた.mp3" buf=1]
#主人公
...
[stopse buf=1]
; ★リスト(tasky_old)一致
[playse storage="tasky/警告：未登録の行動（Unknown Activity）を検知しました。...タスクリストに戻ってください。.mp3" buf=1]
#tasky
...
[stopse buf=1]
[playse storage="narrator/昼休み。同僚のミナはいつも通り、完璧に着こなしたスーツ姿で現れた。以前はよく愚痴を言い合った仲だったが、最近の彼女はどこか違う。隙がないのだ。.mp3" buf=1]
#モノローグ
昼休み。同僚のミナはいつも通り、完璧に着こなしたスーツ姿で現れた。[r]
以前はよく愚痴を言い合った仲だったが、最近の彼女はどこか違う。隙がないのだ。[p]
[stopse buf=1]
[playse storage="narrator/彼女の笑顔は張り付いたように完璧で、そのスコアは常に僕の目標になっている。.mp3" buf=1]
#モノローグ
彼女の笑顔は張り付いたように完璧で、そのスコアは常に僕の目標になっている。[p]

; ★ミナボイス (リスト(mina_old)一致: 70%の前にスペースあり)
[stopse buf=1]
[playse storage="mina/あ、おはよう！ ねぇ、見てこれ！ 私、もう今日の達成率 70%超えちゃった。...使えば使うほど、自分が無敵になったような気がするの.mp3" buf=1]
#ミナ
「あ、おはよう！ ねぇ、見てこれ！[r]
私、もう今日の達成率70%超えちゃった。すごいでしょ？[p]
[cm]
taskyは本当に便利だよね。[r]
使えば使うほど、自分が無敵になったような気がするの」[p]

; ナレーター音声
[stopse buf=1]
[playse storage="narrator/彼女はスマホの画面を突きつけてくる。... 彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。.mp3" buf=1]
#モノローグ
彼女はスマホの画面を突きつけてくる。[r]
そこには、僕より遥かに高いスコアが表示されていた。[r]
彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。[p]
[stopse buf=1]
[playse storage="narrator/その余裕と完璧さが、僕の焦燥感を油のように煽る。...彼女の存在は、僕にとって憧れであり、同時に排除すべき劣等感の源だ。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/す、すごいな、ミナ……。...君の記録をターゲット設定したよ.mp3" buf=1]
#主人公
「す、すごいな、ミナ……。[r]
でも、僕も今日は負けないつもりだ。君の記録をターゲット設定したよ」[p]
[stopse buf=1]
; ★ミナボイス (リスト(mina_old)一致)
[stopse buf=1]
[playse storage="mina/いいわ！ あなたも完璧を目指すべきよ。...負けたくないでしょう？ 競争は私たちのモチベーションを最大化するわ.mp3" buf=1]
#ミナ
「いいわ！ あなたも完璧を目指すべきよ。 負けたくないでしょう？[r]
競争は私たちのモチベーションを最大化するわ 」[p]
[stopse buf=1]
[playse storage="narrator/彼女の挑発的な視線に、背筋がゾクゾクした。...僕は彼女に勝たなければならない。.mp3" buf=1]
#モノローグ
彼女の挑発的な視線に、背筋がゾクゾクした。[r]
そうだ、これはゲームだ。僕は彼女に勝たなければならない。[p]
...
; ★ミナボイス (リスト(mina_old)一致)
[stopse buf=1]
[playse storage="mina/そう……。...社会は待ってくれないんだから.mp3" buf=1]
#ミナ
「そう……。つまらない人ね。[r]
でも、遅れた分は自己責任よ。社会は待ってくれないんだから」[p]
[stopse buf=1]
[playse storage="narrator/競争なんて馬鹿げてる。...taskyの通知が、僕の「正しい道」はどこかと問いかけてくる。.mp3" buf=1]
#モノローグ
競争なんて馬鹿げてる。[r]
しかし、ミナとの差が開くにつれて、僕の中の劣等感は消えない。[r]
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/ねえミナ。...tasky のスコアって、具体的にどういうアルゴリズムで付与されているんだい？ 少し不透明な気がして…….mp3" buf=1]
#主人公
「ねえミナ。[r]
taskyのスコアって、具体的にどういうアルゴリズムで付与されているんだい？[r]
少し不透明な気がして……」[p]
[stopse buf=1]
; ★ミナボイス (リスト(mina_old)一致)
[stopse buf=1]
[playse storage="mina/え？ アルゴリズム？ ……そんなの考えたこともないわ。...それがルールじゃない？ 深く考えるなんて、時間の無駄よ.mp3" buf=1]
#ミナ
「え？ アルゴリズム？ ……そんなの考えたこともないわ。[r]
与えられたものをこなすだけよ。それがルールじゃない？[r]
深く考えるなんて、時間の無駄よ」[p]
[stopse buf=1]
[playse storage="narrator/彼女の瞳が一瞬、曇ったように見えた。...彼女の言葉は、このシステムの本質的な部分に疑問を持たせないよう、巧妙にプログラムされているかのようだ。.mp3" buf=1]
#モノローグ
彼女の瞳が一瞬、曇ったように見えた。[r]
彼女の言葉は、このシステムの 本質的な部分 に疑問を持たせないよう、[r]
巧妙にプログラムされているかのようだ。[p]
[stopse buf=1]
[playse storage="narrator/無関心こそが、このシステムの理想なのかもしれない。.mp3" buf=1]
#モノローグ
...
; T1-2'
[stopse buf=1]
[playse storage="narrator/ミナとの競争を決意した瞬間、スマホにtaskyからの追加タスクが表示された。...こちらの心拍数上昇を検知したのか？.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/競争モード起動：『昼休憩中の効率的な栄養補給』をミナとの間で競います。... 報酬：特別称号『競合個体優位（アルファ）』。.mp3" buf=1]
#tasky
競争モード起動：『昼休憩中の効率的な栄養補給』をミナ・Sとの間で競います。[r]
勝利条件：3分以内の摂取完了。 報酬：特別称号『競合個体優位（アルファ）』。[p]
[stopse buf=1]
[chara_hide name="tasky"]
; ★ミナボイス (リスト(mina_new)一致)
[stopse buf=1]
[playse storage="mina/私、もうプロテインバーの摂取、終わっちゃったわよ。...あなたはどう？ まだお弁当なんて広げてるの？.mp3" buf=1]
#ミナ
「私、もうプロテインバーの摂取、終わっちゃったわよ。[r]
あなたはどう？ まだお弁当なんて広げてるの？」[p]
[stopse buf=1]
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/ちくしょう、僕も今すぐやる！.mp3" buf=1]
#主人公
「ちくしょう、僕も今すぐやる！」[p]
[stopse buf=1]
[playse storage="narrator/僕は味わうこともなくゼリー飲料を喉に流し込んだ。.mp3" buf=1]
#モノローグ
僕は味わうこともなくゼリー飲料を喉に流し込んだ。[p]
[playse storage="SE04 報酬音（ファンファーレ）.mp3"]
[quake count=3 time=300 vmax=15]
[stopse buf=1]
[playse storage="narrator/胃が重いが、脳は冴えている。...競争に勝った快感は、通常の報酬よりも強烈で暴力的だ。.mp3" buf=1]
#モノローグ
胃が重いが、脳は冴えている。[r]
競争に勝った快感は、通常の報酬よりも強烈で暴力的だ。[p]
[stopse buf=1]
; ★ミナボイス (リスト(mina_old)一致)
[stopse buf=1]
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/馬鹿げてる……。...僕はこれを拒否する.mp3" buf=1]
#主人公
「馬鹿げてる……。昼食くらい、美味しく食べさせてくれ。[r]
僕はこれを拒否する」[p]
[stopse buf=1]
...
[stopse buf=1]
; ★リスト(tasky_old)一致
[playse storage="tasky/警告：競合優位性の獲得を怠りました。...自己評価の低下、およびコミュニティ内ランクの降格が予測されます。.mp3" buf=1]
#tasky
警告：競合優位性の獲得を怠りました。[r]
自己評価の低下、およびコミュニティ内ランクの降格が予測されます。[p]
[stopse buf=1]
[chara_hide name="tasky"]
[playse storage="narrator/不味い弁当になった。...ミナの勝ち誇った顔が直視できない。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(tasky_old)一致
[playse storage="tasky/新規タスク：「友人（カテゴリ：親密）との連絡」を認識しました。...報酬：コミュニケーションポイント 50pt。.mp3" buf=1]
#tasky
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/地元の友人から連絡が来ている。... 今日は疲れているから、明日ゆっくり返信しようと思っていた。.mp3" buf=1]
#モノローグ
地元の友人から連絡が来ている。「久しぶりに飲まないか？」という誘いだ。[r]
今日は疲れているから、明日ゆっくり返信しようと思っていた。[p]
[stopse buf=1]
[playse storage="narrator/だが、taskyがそれを「タスク」にしてきた。...「友人と話す」ことさえ、ポイント稼ぎの手段になってしまった。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(hero_new)一致
[playse storage="hero/……ごめん。...今はタスクの方が大事なんだ.mp3" buf=1]
#主人公
「……ごめん。今はタスクの方が大事なんだ」[p]
[stopse buf=1]
; ★リスト(hero_new)一致
[playse storage="hero/僕は通知をスワイプして消去した。.mp3" buf=1]
#主人公
僕は通知をスワイプして消去した。[p]
; Taskyボイス
[stopse buf=1]
; ★リスト(tasky_old)一致
[playse storage="tasky/あなたは目標達成を優先しました。...不必要な人間関係の維持よりも、あなた自身の成長こそが重要です。.mp3" buf=1]
#tasky
あなたは目標達成を優先しました。素晴らしい判断です。[r]
不必要な人間関係の維持よりも、あなた自身の成長こそが重要です。[p]
[stopse buf=1]
[playse storage="narrator/taskyに肯定されると、現実の人間関係がどうでもいいノイズに思えてくる。...人間関係の煩わしさから解放された気分だ。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(hero_new)一致
[playse storage="hero/「待たせてごめん！ 行きたいね」と打ち込み、返信した。.mp3" buf=1]
#主人公
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/警告：効率が低下しました。.mp3" buf=1]
#tasky
警告：効率が低下しました。[p]
[stopse buf=1]
[playse storage="narrator/送信ボタンを押した瞬間、taskyが不満げな警告音を鳴らしている。.mp3" buf=1]
#モノローグ
送信ボタンを押した瞬間、taskyが不満げな警告音を鳴らしている。[r]
[playse storage="narrator/これでよかったのか？ スコアが下がっている……と、常に頭の隅で計算している自分がいる。.mp3" buf=1]
これでよかったのか？ スコアが下がっている……と、常に頭の隅で計算している自分がいる。[r]
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/ごめん、今 tasky のタスクで手が離せないんだ。...君もやってるだろ？ 知ってるよね？.mp3" buf=1]
#主人公
「ごめん、今taskyのタスクで手が離せないんだ。[r]
君もやってるだろ？ 知ってるよね？」[p]
[stopse buf=1]
[playse storage="narrator/既読がついたが、返信は来ない。...友人は戸惑っているようだ。.mp3" buf=1]
#モノローグ
既読がついたが、返信は来ない。友人は戸惑っているようだ。[r]
[playse storage="narrator/僕にはtaskyの報酬の方が重要だ……そう自分に言い聞かせるが、胸のつかえが取れない。.mp3" buf=1]
僕にはtaskyの報酬の方が重要だ……そう自分に言い聞かせるが、胸のつかえが取れない。[r]
[playse storage="narrator/依存度は下がらないが、この行動が本当に正しいのか、ふと疑問がよぎる。.mp3" buf=1]
...
; T1-3'
[stopse buf=1]
[playse storage="narrator/連絡を無視した。しかし、すぐにtaskyから「関係性維持の最適化」という新規タスクが提示された。〜という定型文がすでに用意されている。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(hero_new)一致
[playse storage="hero/（タップ一つで送信完了）……これでよし。...ポイントゲットだ。.mp3" buf=1]
#主人公
（タップ一つで送信完了）……これでよし。ポイントゲットだ。[p]
[stopse buf=1]
[playse storage="narrator/そこに心はない。...僕はログを作る機械になりつつある。.mp3" buf=1]
#モノローグ
...
[eval exp="f.f_fat = f.f_fat + 5"]
[stopse buf=1]
[playse storage="narrator/もうたくさんだ。...僕の家族への言葉まで、お前が決めるのか？.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/警告。適切な関係維持は社会的信用の基盤です。あなたのポートフォリオに傷がつきます。.mp3" buf=1]
#tasky
...
報酬：夜間特別ポイント（2倍）。[r]
これはあなたが社会的に優位に立つための 必須タスク です。[p]
[stopse buf=1]

; ナレーター音声
[stopse buf=1]
[playse storage="narrator/疲労はピークだ。...眼球の奥がズキズキと痛み、視界が滲む。.mp3" buf=1]
#モノローグ
疲労はピークだ。体は悲鳴を上げ、休息を求めている。[r]
眼球の奥がズキズキと痛み、視界が滲む。[p]
[stopse buf=1]
[playse storage="narrator/それでも、〜……その一文が、死刑宣告のように感じられる。.mp3" buf=1]
#モノローグ
それでも、このタスクをクリアしなければ、[r]
僕の今日の「努力」は宙に浮いたままになる気がして、怖い。[p]
[cm]
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/画面が激しく明滅し、ファンファーレが鳴り響く。.mp3" buf=1]
#モノローグ
画面が激しく明滅し、ファンファーレが鳴り響く。[p]
[stopse buf=1]
[playse storage="narrator/疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、痺れるような快感が全身を駆け巡る。...これこそが、僕の存在証明だ。.mp3" buf=1]
#モノローグ
疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、[r]
痺れるような快感が全身を駆け巡る。[r]
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/……（ため息）もう無理だ。...全てを放棄したっていい.mp3" buf=1]
#主人公
「……（ため息）もう無理だ。休もう。全てを放棄したっていい」[p]
[stopse buf=1]
[playse storage="narrator/僕はスマホを裏返した。.mp3" buf=1]
#モノローグ
僕はスマホを裏返した。[p]
[chara_mod name="tasky" face="warning"]
[playse storage="SE03 警報音.mp3"]
...
[stopse buf=1]
; ★リスト(tasky_old)一致
[playse storage="tasky/お休み前にもタスク未達。...残念です。.mp3" buf=1]
#tasky
お休み前にもタスク未達。あなたの連続記録（ストリーク）は途切れます。残念です。[p]
[stopse buf=1]
[playse storage="narrator/taskyの通知が、まるで社会的な軽蔑の言葉のように響く.休めても、明日からの不安が、回復したわずかな気力を食いつぶしていく。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
[playse storage="narrator/taskyは僕の理性的な要求さえ拒絶する。...しかし、依頼したという行為は、心の中に小さな「NO」という抵抗の証として残った。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/おめでとうございます。...今ならレートアップ中。.mp3" buf=1]
#tasky
おめでとうございます。獲得したポイントを消費し、自己承認欲求を更に満たしませんか？[r]
推奨： 限定アバターの購入 、または ソーシャルゲームへの課金連携 。[r]
今ならレートアップ中。[p]
[stopse buf=1]
...
[stopse buf=1]
[playse storage="narrator/指が勝手に動く。...報酬を消費することで、空虚さが埋まるかと思ったが、逆だった。.mp3" buf=1]
#モノローグ
指が勝手に動く。[r]
報酬を消費することで、空虚さが埋まるかと思ったが、逆だった。[p]
[stopse buf=1]
[playse storage="narrator/更に次の報酬が欲しくなる。...この快感のループから抜け出せない。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/……疲れている。...これ以上、ドーパミンの奔流はいらない.mp3" buf=1]
#主人公
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/警告：資源の適切な循環を怠っています。...経済活動への貢献度が低下。.mp3" buf=1]
#tasky
...
[stopse buf=1]
; ★リスト(tasky_new)一致
[playse storage="tasky/ご提案。...食事の時間も最適化しましょう。.mp3" buf=1]
#tasky
ご提案。休憩時間です。[r]
タスクリストに『自己投資：栄養補助食品の摂取』を追加しました。[r]
これは効率的な肉体維持のためです。食事の時間も最適化しましょう。[p]
[stopse buf=1]
[playse storage="narrator/taskyは僕の栄養状態まで管理し始めた。...僕の行動は、完全にtaskyの設計の範疇にある。.mp3" buf=1]
#モノローグ
...
[eval exp="f.f_dep = f.f_dep + 10"]
[stopse buf=1]
[playse storage="narrator/taskyが言うのなら、これは合理的な自己投資だ。...何を食べるか考える手間がない分、余計なエネルギーを使わずに済む。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト(hero_old)一致
[playse storage="hero/読みたい本があるんだ。...これは tasky のタスクではないが、僕にとって必要なことだ.mp3" buf=1]
#主人公
「読みたい本があるんだ。[r]
これはtaskyのタスクではないが、僕にとって必要なことだ」[p]
[stopse buf=1]
[playse storage="narrator/本を開くが、内容が入ってこない。...システムへの抵抗と、従わないことへの不安の衝突が、既に疲労として蓄積している。.mp3" buf=1]
#モノローグ
