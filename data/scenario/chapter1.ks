...
[position layer=message0 page=fore margint=45 marginb=10 marginl=50 marginr=50 visible=true]
...
#tasky
おはようございます。現在時刻、午前7時00分。[r]
睡眠効率92%。良好です。[r]
タスクリスト更新：『朝のストレッチと深呼吸』を認識しました。[p]
[cm]
完了してください。[p]
...
未読メッセージが3件あります。[r]
完了してください。報酬：コミュニケーションポイント 50pt。[p]
[stopse buf=1]
...
#tasky
お休み前にもタスク未達。あなたの連続記録（ストリーク）は途切れます。[r]
残念です。[p]
[stopse buf=1]
