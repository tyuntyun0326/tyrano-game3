...
[bg storage="myroom_mooning.jpg" time="1000"]
[playbgm storage="BGM_02_日常.mp3" volume="50"]
[playse storage="SE02通常通知音.mp3"]

; ナレーター音声
[stopse buf=1]
[playse storage="narrator/tasky を導入して数日。...それは、単なるアラームではなく、僕が社会的に価値ある存在であることを保証してくれるファンファーレだ。.wav" buf=1]
#モノローグ
...
; ★演出：Tasky起動と共に机へフォーカス (myroom_mooning.jpg)
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/画面が黄金色に輝く。...また明日もこれをやりたい、と無意識に渇望してしまう。.wav" buf=1]
#モノローグ
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。...彼女の存在は、僕にとって憧れであり、同時に排除すべき劣等感の源だ。.wav" buf=1]
#モノローグ
...
*T1_3
[chara_hide_all time=500]
; ★修正：myroom_sunset.jpg
[bg storage="myroom_sunset.jpg" time="1000"]
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/僕の私的な時間までもが、管理の対象になっていく。...すべてがタスク化されていくことに、僕は管理される心地よさと、微かな恐怖を同時に覚える。.wav" buf=1]
#モノローグ
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/疲労はピークだ。...「今日の成果が無効になる」……その一文が、死刑宣告のように感じられる。.wav" buf=1]
#モノローグ
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、痺れるような快感が全身を駆け巡る。...これが僕の生きる目的だ。.wav" buf=1]
#モノローグ
