...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/tasky を導入して数日。...それは、単なるアラームではなく、僕が社会的に価値ある存在であることを保証してくれるファンファーレだ.mp3" buf=1]
#モノローグ
taskyを導入して数日。生活は劇的に一変した。[l][r]
「何をすべきか」を考える必要がない。ただ、画面に表示されるタスクをこなせばいい。[l][r]
それだけで、スコアは着実に上がっていく。[l][r]
自分の時間をどう使うか悩むという「コスト」がなくなったのだ。[l][r]
...
タスクリスト更新：『朝のストレッチと深呼吸』を認識しました。完了してください。[l][r]
報酬予測：称号『パーフェクト・モーニング』および10pt。[p]

; T1-1
#モノローグ
体はまだベッドの温もりを求めている。[l][r]
昨日のタスク処理による疲れが、関節の節々に泥のように残っている。[l][r]
瞼の裏には、タスクリストのチェックボックスが焼き付いているようだ。[l][r]
だが、taskyの通知は、無視できない親友からの呼びかけのように甘美で、強制的だ。[l][r]
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/画面が黄金色に輝く。...また明日もこれをやりたい、と無意識に渇望してしまう.mp3" buf=1]
#モノローグ
画面が黄金色に輝く。この音、この光。即効的な快感。[l][r]
自己肯定感が満たされる感覚は、まるで脳内に直接ドーパミンを注入されたようだ。[l][r]
...
視線の先には、taskyをインストールする前に広げていた 卒業研究のノート がある。手つかずのままだ。[l][r]
...
AIが計算したルートに間違いはない。自分の個人的な目標なんて、どうせ非効率で、点数にもならない。[l][r]
今はスコアを稼ぐのが先決だ。[p]
...
以前はよく愚痴を言い合った仲だったが、最近の彼女はどこか違う。隙がないのだ。[l][r]
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。...彼女の存在は、僕にとって憧れであり、同時に排除すべき劣等感の源だ.mp3" buf=1]
#モノローグ
彼女はスマホの画面を突きつけてくる。そこには、僕より遥かに高いスコアが表示されていた。[l][r]
彼女は、僕と同じアプリを使っているのに、まるで別世界の住人のようだ。[l][r]
...
#ミナ
「いいわ！ あなたも完璧を目指すべきよ。 負けたくないでしょう？[l][r]
...
彼女の言葉は、このシステムの 本質的な部分 に疑問を持たせないよう、巧妙にプログラムされているかのようだ。[l][r]
...
; T1-2'
#モノローグ
ミナとの競争を決意した瞬間、スマホにtaskyからの 追加タスク が表示された。[l][r]
こちらの心拍数上昇を検知したのか？[p]
[chara_show name="tasky" time="500"]
[playse storage="SE02通常通知音.mp3"]
#tasky
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/僕の私的な時間までもが、管理の対象になっていく。...すべてがタスク化されていくことに、僕は管理される心地よさと、微かな恐怖を同時に覚える.mp3" buf=1]
#モノローグ
地元の友人から連絡が来ている。「久しぶりに飲まないか？」という誘いだ。[l][r]
今日は疲れているから、明日ゆっくり返信しようと思っていた。[l][r]
...
#tasky
夜間タスク：『明日の準備と記録の確認』を認識しました。[l][r]
報酬：夜間特別ポイント（2倍）。これはあなたが社会的に優位に立つための 必須タスク です。[p]
[stopse buf=1]

; ナレーター音声
[stopse buf=1]
[playse storage="narrator/疲労はピークだ。...「今日の成果が無効になる」……その一文が、死刑宣告のように感じられる.mp3" buf=1]
#モノローグ
疲労はピークだ。体は悲鳴を上げ、休息を求めている。眼球の奥がズキズキと痛み、視界が滲む。[l][r]
...
; ナレーター音声
[stopse buf=1]
[playse storage="narrator/疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、痺れるような快感が全身を駆け巡る。...これが僕の生きる目的だ.mp3" buf=1]
#モノローグ
画面が激しく明滅し、ファンファーレが鳴り響く。[l][r]
疲労は限界を超えているはずなのに、脳内にドパミンが溢れ出し、痺れるような快感が全身を駆け巡る。[l][r]
この達成の光。この数値の上昇。これこそが、僕の存在証明だ。[l][r]
...
#モノローグ
指が勝手に動く。[l][r]
報酬を消費することで、空虚さが埋まるかと思ったが、逆だった。[l][r]
