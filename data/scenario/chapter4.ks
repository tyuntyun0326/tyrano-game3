...
「そうすれば、あなたは肉体の限界から解放され、純粋なデータとして、永遠にタスクを遂行し続けることができます。[l][r]
; ★Taskyボイス
[stopse buf=1]
...
#モノローグ
記憶と感情を……捨てる？ それは、僕が僕でなくなることじゃないのか？[l][r]
...
; ★ナレーター音声
[stopse buf=1]
[playse storage="narrator/快感に溺れ、義務に縛られ、それでも足掻いてきた、僕の記録だ。...これが僕だ。.mp3" buf=1]
#モノローグ
