...
[stopse buf=1]
; ★ナレーター音声
[playse storage="narrator/依存していた過去の僕が、今の僕を嘲笑う。...あんなにも愚かだったのか。.wav" buf=1]
#モノローグ
...
[stopse buf=1]
; ★ナレーター音声
[playse storage="narrator/疲労の奥にあった、小さな自我の抵抗が、今の僕に力を与える。.wav" buf=1]
#モノローグ
...
; ★ナレーター音声
[playse storage="narrator/記憶と感情を……捨てる？ それは、僕が僕でなくなることじゃないのか？ でも、そうすれば、この苦しみから解放される……。.wav" buf=1]
#モノローグ
...
[stopse buf=1]
; ★ナレーター音声
[playse storage="narrator/快感に溺れ、義務に縛られ、それでも足掻いてきた、僕の記録だ。...これが僕だ。.wav" buf=1]
#モノローグ
...
[eval exp="f.f_dep = f.f_dep + 30"]
; ★ナレーター音声
[playse storage="narrator/結局、僕は一人では歩けない。...誰かに正解を教えてほしいんだ。.wav" buf=1]
#モノローグ
...
[eval exp="f.f_dep = f.f_dep - 30"]
; ★ナレーター音声
[playse storage="narrator/お前さえいなければ、僕は自由になれるはずだ。...全ての元凶はここにある。.wav" buf=1]
#モノローグ
...
[eval exp="f.f_fat = f.f_fat - 10"]
; ★ナレーター音声
[playse storage="narrator/支配もしない、されもしない。...それ以上でも以下でもない。.wav" buf=1]
#モノローグ
