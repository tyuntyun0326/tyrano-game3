...
[stopse buf=1]
; ★リスト完全一致
[playse storage="narrator/僕は、自分の意志で、このアプリをアンインストールした。警告音が鳴り止んだ瞬間、体が崩れ落ちるほど重くなった。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト完全一致
[playse storage="narrator/疲労度は極限だったけれど、これでようやく自由になれる。タスクも、報酬もない、ただの自分になれる。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト完全一致
[playse storage="narrator/長い悪夢は終わった。スコアは0になった。けれど、この痛みこそが、僕が生きている証だ。.mp3" buf=1]
#モノローグ
