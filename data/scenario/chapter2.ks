...
#モノローグ
taskyの通知音も、どこか鈍い、耳障りな音に変わっている。[r]
...
[elsif exp="f.f_fat > f.f_dep"]
    #モノローグ
    (疲弊型脱落予備軍ルート)[r]
    疲れている。体が鉛のように重い。指一本動かすのも億劫だ。しかし、やめられない。[r]
...
; 主人公ボイス
[stopse buf=1]
[playse storage="hero/それは非効率だ。...君の君でやるべきだ.mp3" buf=1]
#主人公
...
#ミナ (チャット)
「実は今日、上司から昇進リストの件でプレッシャーがすごくて... タスク量が多すぎるの。[r]
