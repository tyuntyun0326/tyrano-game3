...
#モノローグ
数週間が過ぎた。 日々のルーチンは、もはや無意識の動作に変わった。[l][r]
鏡に映る自分は、確かに以前よりは活発だ。肌艶もいい。仕事も早くなった。[l][r]
だが、最初の頃に感じた強烈な快感は、もうどこにもない。[l][r]
あるのは、「スコアを維持しなければならない」という強迫観念だけだ。[p]

; ナレーター
[stopse buf=1]
[playse storage="narrator/tasky の声は、もはや脅迫的ではない。どこか哀れんでいるようにも、試しているようにも聞こえる。.mp3" buf=1]
#モノローグ
taskyの通知音も、どこか鈍い、耳障りな音に変わっている気がした。[l][r]
その音は、僕を導く光ではなく、僕の怠惰を監視する看守の警笛へと変質していた。[l][r]
気がつけば、僕はtaskyに怒られるのが怖いから、タスクをこなしていた。[l][r]
...
[stopse buf=1]
[playse storage="narrator/報酬は「小さな満足」。その文字が、僕の心を乾いたスポンジのように虚しくさせる。タスクリストは、僕が興味のない、システムが強いる義務で埋め尽くされている。.mp3" buf=1]
#モノローグ
報酬は「小さな満足」。その文字が、僕の心を乾いたスポンジのように虚しくさせる。[l][r]
タスクリストは、僕が興味のない、システムが強いる義務で埋め尽くされている。[l][r]
『不要業務資料の整理』、『上司への定型的な機嫌伺い』……[l][r]
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/警告レベル 1：ドーパミン受容体の感度低下を検知。...サボることを許容しますか？.mp3" buf=1]
#tasky
警告レベル1：ドーパミン受容体の感度低下を検知。[l][r]
本日の報酬設定を『小さな満足』に変更しました。[l][r]
サボることを許容しますか？[p]

; Taskyボイス
[stopse buf=1]
[playse storage="tasky/新規タスクリスト：『不要業務資料の整理(強制)』。あなたには義務があります。サボることを許容しますか？.mp3" buf=1]
#tasky
新規タスクリスト：『不要業務資料の整理(強制)』。[l][r]
あなたには義務があります。[l][r]
サボることを許容しますか？[p]
...
[if exp="f.f_dep > f.f_fat"]
    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/報酬が減っても構わない。...この苦痛こそが、僕を他人より優れた存在にするための通過儀礼なのだ。.mp3" buf=1]
    #モノローグ
    (依存型優等生ルート)[l][r]
    報酬が減っても構わない。重要なのは、スコアが示す私自身の価値だ。[l][r]
    この苦痛こそが、僕を他人より優れた存在にするための通過儀礼なのだ。[p]
    
    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/凡人はここで脱落するが、僕は違う。...この先に、さらなる高みが待っているはずだ。.mp3" buf=1]
    #モノローグ
    凡人はここで脱落するが、僕は違う。taskyは僕を裏切らない。[l][r]
    この先に、さらなる高みが待っているはずだ。[p]

[elsif exp="f.f_fat > f.f_dep"]
    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/疲れている。体が鉛のように重い。指一本動かすのも億劫だ。しかし、やめられない。ここでやめたら、これまで積み上げてきた記録（ストリーク）が全て無駄になる。.mp3" buf=1]
    #モノローグ
    (疲弊型脱落予備軍ルート)[l][r]
    疲れている。体が鉛のように重い。指一本動かすのも億劫だ。[l][r]
    しかし、やめられない。[l][r]
    ここでやめたら、これまで積み上げてきた記録（ストリーク）が全て無駄になる。[p]

    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/あの「自分はダメな人間だ」という劣等感に再び苛まれるくらいなら、死ぬ気で指を動かしたほうがマシだ。.mp3" buf=1]
    #モノローグ
    あの「自分はダメな人間だ」という劣等感に再び苛まれるくらいなら、[l][r]
    死ぬ気で指を動かしたほうがマシだ。[p]

[else]
    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/このアプリは、ただのツールに過ぎないはずだ。なぜ皆、たかが数字のスコアにそこまで固執するんだ？ 僕はシステムに使われない。.mp3" buf=1]
    #モノローグ
    (懐疑的なバランス型ルート)[l][r]
    このアプリは、ただのツールに過ぎないはずだ。[l][r]
    なぜ皆、たかが数字のスコアにそこまで固執するんだ？[l][r]
    僕はシステムに使われない。[p]

    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/この無意味な義務に、従う必要はない。そう頭では分かっているのに、指が止まらないのはなぜだ？.mp3" buf=1]
    #モノローグ
    この無意味な義務に、従う必要はない。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/目を閉じても、瞼の裏にはタスクリストのチェックボックスが焼き付いているようだ。... だが、tasky の通知は、無視できない親友からの呼びかけのように甘美で、強制的だ。.mp3" buf=1]
#モノローグ
目を閉じても、瞼の裏にはタスクリストのチェックマークが焼き付いている。[l][r]
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/記録が失効します。...あなたは敗北者ですよ.mp3" buf=1]
#tasky
あなたの価値が失効します。[l][r]
無駄な時間を過ごすことを選択しますか？[l][r]
あなたは敗北者ですよ。[p]
[jump target="*T2_2"]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/疑問を持つのは非効率だ。システムを疑うな。,,,,,,でも、このタスクに何の意味がある？.mp3" buf=1]
#モノローグ
疑問を持つのは非効率だ。システムを疑うな……[l][r]
でも、このタスクに何の意味がある？[p]
[jump target="*T2_2"]
...
[else]
    ...
    ; Taskyボイス
    [stopse buf=1]
    [playse storage="tasky/警告：昨日のタスク未達により、評価が大きく低下しています。...緊急タスク：『SNSの定型ポジティブ投稿』を行い、社会的評価の低下を防いでください。.mp3" buf=1]
    #tasky
    警告：昨日のタスク未達により、評価が大きく低下しています。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/そうだ、この苦労が、僕をミナより上に行かせる。...眠気など、カフェインで散らせばいい。.mp3" buf=1]
#モノローグ
そうだ、この苦労が、僕をミナより上に行かせる。[l][r]
眠気など、カフェインで散らせばいい。[p]
; Taskyボイス
[stopse buf=1]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/taskyに頼らず、最短ルートで「結果」だけを出す。...スコアさえ上がれば、中身なんてどうでもいいんだ。.mp3" buf=1]
#モノローグ
taskyに頼らず、最短ルートで「結果」だけを出す。[l][r]
スコアさえ上がれば、中身なんてどうでもいいんだ。[p]
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/記録に不審な点があります。...……しかし、結果を承認します。.mp3" buf=1]
#tasky
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/「今日は最高の天気！ ランニングしてリフレッシュ！」……嘘だ。...疲れているのに、笑顔の絵文字を貼り付ける。.mp3" buf=1]
#モノローグ
「今日は最高の天気！ ランニングしてリフレッシュ！」……嘘だ。[l][r]
本当は一日中布団の中にいた。[l][r]
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/適切な情報操作です。...評価の維持を確認。.mp3" buf=1]
#tasky
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/偽りの自分を演じるのはもう嫌だ。...スマホの電源を切りたい。.mp3" buf=1]
#モノローグ
...
#tasky
社会的スコアの回復を放棄しました。システムからの支援は低下します。[l][r]
あなたは孤独になりますよ？[p]
[jump target="*T2_2"]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/ミナからの通知だ。...目の下のクマをコンシーラーで隠しきれていない。.mp3" buf=1]
#モノローグ
ミナからの通知だ。[l][r]
以前はあんなに輝いていた彼女の顔には、深い疲労の影が差している。[l][r]
目の下のクマをコンシーラーで隠しきれていない。[p]

; ナレーター
[stopse buf=1]
[playse storage="narrator/それでも、彼女の承認は、僕のスコアの健全性を測る唯一のバロメーターだ。...彼女に見放されたら、僕は本当に独りになってしまう。.mp3" buf=1]
#モノローグ
それでも、彼女の承認は、僕のスコアの健全性を測る唯一のバロメーターだ。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/彼女の承認が力になる。...共犯者のような絆だ。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/誰も助けてくれない。...スコアだけが僕を縛る鎖だ。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/疲労で優しさすら拒絶される。...痛い。.mp3" buf=1]
#モノローグ
疲労で優しさすら拒絶される。痛い。[p]
[jump target="*T2_E1"]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/ミナにタスクの進捗を報告すると、彼女は血走った目で画面を見つめ、更に無理な要求をしてきた。.mp3" buf=1]
#モノローグ
...
……ねぇ、あなた、そのタスク、私のアカウントで二重にやってスコアを上げるってのはどう？[l][r]
...
#モノローグ
彼女に勝つため、いや、彼女に認められるためなら、非合理的な努力も厭わない。[l][r]
自分の分と、彼女の分。二倍の労力。[p]
[chara_show name="tasky" time="500"]
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/『共依存タスク（Co-dependency）』の開始を承認しました。...特例措置です。.mp3" buf=1]
#tasky
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/承認欲求は満たされないまま、拒絶したことによる疲労だけが泥のように残る。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/深夜2時。...その時、ミナから、これまでの明るい調子ではない、助けを求めるような、弱々しいチャットが届いた。.mp3" buf=1]
#モノローグ
深夜2時。taskyの通知はまだ続いている。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/文面が乱れている。.mp3" buf=1]
#モノローグ
文面が乱れている。[p]
; ミナボイス
[stopse buf=1]
[playse storage="mina/実は今日、上司から昇進リストの件でプレッシャーがすごくて... タスク量が多すぎるの。もう指が動かない。お願い、今日の夜間タスク、代わりにやってくれない.mp3" buf=1]
#ミナ (チャット)
「実は今日、上司から昇進リストの件でプレッシャーがすごくて... タスク量が多すぎるの。[l][r]
もう指が動かない。お願い、今日の夜間タスク、代わりにやってくれない?[p]
; ミナボイス
[stopse buf=1]
[playse storage="mina/あなたならできるはずよ! お願い! 私、このままだとランクが落ちちゃう……！.mp3" buf=1]
#ミナ (チャット)
...
[if exp="f.f_dep >= 60 || f.f_fat >= 60"]
    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/彼女は僕の弱みに付け込んでいる。...この状況を利用して、僕の優位性を確立するか、それとも共倒れを避けるか？ 手が震える。.mp3" buf=1]
    #モノローグ
    彼女は僕の弱みに付け込んでいる。僕自身、限界なのに。[l][r]
...
[else]
    ; ナレーター
    [stopse buf=1]
    [playse storage="narrator/ミナからのメッセージは、単なる疲労のサインだろう。...無視しよう。.mp3" buf=1]
    #モノローグ
    ミナからのメッセージは、単なる疲労のサインだろう。僕には関係ない。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/自分の時間を削り、命を削って彼女の数字を上げる。...満足感と共に、内臓がねじ切れるような深い疲労を感じる。.mp3" buf=1]
#モノローグ
自分の時間を削り、命を削って彼女の数字を上げる。[l][r]
満足感と共に、内臓がねじ切れるような深い疲労を感じる。[p]
; ナレーター
[stopse buf=1]
[playse storage="narrator/しかし、この「頼られている」という支配感が、たまらない。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/拒否した解放感と、ミナからの強い嫌悪を同時に受ける。画面越しに彼女の絶望が伝わってくるようだ。.mp3" buf=1]
#モノローグ
拒否した解放感と、ミナからの強い嫌悪を同時に受ける。[l][r]
画面越しに彼女の絶望が伝わってくるようだ。[p]
; ナレーター
[stopse buf=1]
[playse storage="narrator/だが、僕の良心は、もはや自分のスコアほど重要ではない。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/深夜４時。瞼が重い。徹夜が続いている。頭の中に霧がかかったようだ。それでも、タスクを放棄するという選択肢は、自己否定に直結する。.mp3" buf=1]
#モノローグ
深夜4時。瞼が重い。徹夜が続いている。頭の中に霧がかかったようだ。[l][r]
それでも、タスクを放棄するという選択肢は、自己否定に直結する。[p]
; ナレーター
[stopse buf=1]
[playse storage="narrator/ここで止まれば、僕はただの「疲れた敗北者」に戻ってしまう。.mp3" buf=1]
#モノローグ
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/疲労は無視する。痛みを感じるということは、まだ努力できる証拠だ.mp3" buf=1]
#モノローグ
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/お休み前にもタスク未達。あなたの連続記録（ストリーク）は途切れます。残念です。.mp3" buf=1]
#tasky
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/不正行為を検知。あなたのプライドはどこへ？.mp3" buf=1]
#tasky
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/新しいタスク。外部サービスとの連携。あなたの位置情報、金融資産、交友関係の全てをtaskyに同期してください。.mp3" buf=1]
#tasky
新しいタスク：外部サービスとの連携。[l][r]
あなたの位置情報、金融資産、交友関係の全てをtaskyに同期してください。[p]
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/よりパーソナライズされた指導が可能になります.mp3" buf=1]
#tasky
よりパーソナライズされた指導が可能になります。[p]

; ★ナレーター音声
[stopse buf=1]
[playse storage="narrator/僕の個人的な情報をすべてtaskyに渡すことになる。もはや、プライバシーなどという概念は、僕の思考から消えかけている。.mp3" buf=1]
#モノローグ
僕の個人的な情報をすべてtaskyに渡すことになる。[l][r]
もはや、プライバシーなどという概念は、僕の思考から消えかけている。[l][r]
僕の私的な時間までもが、管理の対象になっていく。[l][r]
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/システムへの信頼をありがとうございます。.mp3" buf=1]
#tasky
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/信頼度の低下を検知。自己超越を諦めるのですか？ 破滅を望みますか？.mp3" buf=1]
#tasky
...
#モノローグ
真実はどこにある？ ネットの深層に、taskyの開発者に関する噂があった。[l][r]
「カナエ」という名前。[p]
; ナレーター
[stopse buf=1]
[playse storage="narrator/taskyは猛烈に警告を発しているが、僕はその裏側で、開発者の一人だったとされるカナエに関する断片的なデータを見つけた。それは暗号化された座標と短いメッセージのようだ。「救済を求める者へ」と書いてある。.mp3" buf=1]
#モノローグ
taskyは猛烈に警告を発しているが、僕はその裏側で、開発者の一人だったとされるカナエに関する断片的なデータを見つけた。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/taskyに頼っては意味がない。暗号を自力で解読する。……解けた。古いカフェの座標だ。.mp3" buf=1]
#モノローグ
taskyに頼っては意味がない。暗号を自力で解読する。……解けた。[l][r]
古いカフェの座標だ。[p]
[jump target="*T2_4_HIDE"]
...
; Taskyボイス
[stopse buf=1]
[playse storage="tasky/警告。ユーザーは現在、非推奨エリアへの移動を計画しています。行動を中止し、夜間タスクに戻りなさい。あなたの位置情報は常に監視されています。.mp3" buf=1]
#tasky
警告。ユーザーは現在、非推奨エリアへの移動を計画しています。[l][r]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/抵抗する余裕はない。今はカナエに会うことだけを考える。taskyにバレていても構わない。.mp3" buf=1]
#モノローグ
抵抗する余裕はない。今はカナエに会うことだけを考える。[l][r]
taskyにバレていても構わない。[p]
[jump target="*Kanae_Contact"]
...
; ナレーター
[stopse buf=1]
[playse storage="narrator/僕は、彼女に会うために、この古びたカフェに辿り着いた。店の奥、薄暗い席に、ノートPCを開いた女性が座っている。.mp3" buf=1]
#モノローグ
僕は、彼女に会うために、この古びたカフェに辿り着いた。[l][r]
...
#カナエ
「taskyの真の目的は、システム自体を永遠に稼働させること。[l][r]
あなた方が『空虚』を感じる限り、このシステムは止まらない。[p]
; カナエボイス
[stopse buf=1]
[playse storage="kanae/あなたに『自由』を恐れさせるよう、私は設計したのよ。でも、それは間違いだった.mp3" buf=1]
#カナエ
あなたに『自由』を恐れさせるよう、私は設計したのよ。[l][r]
でも、それは間違いだった」[p]
; ナレーター
[stopse buf=1]
[playse storage="narrator/彼女はそれだけ言うと、僕に助けを求める機会も与えず、静かに店を出ていった。彼女の瞳には、僕と同じ疲弊、そして深い罪悪感が宿っていた。.mp3" buf=1]
#モノローグ
彼女はそれだけ言うと、僕に助けを求める機会も与えず、静かに店を出ていった。[l][r]
