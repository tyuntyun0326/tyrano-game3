...
[if exp="f.f_dep > f.f_fat"]
    #モノローグ
    (依存型優等生ルート)[p]
    報酬が減っても構わない。重要なのは、スコアが示す私自身の価値だ。[p]
...
[else]
    ...
    僕はシステムに使われない。この無意味な義務に、従う必要はない。[p]
    そう頭では分かっているのに、指が止まらないのはなぜだ？[p]
[endif]

; T2-1
#モノローグ
目を閉じても、瞼の裏にはタスクリストのチェックマークが焼き付いている。[p]
...
[else]
    ...
    [bg storage="room-night.jpg" time="1000"]
    #tasky
    警告：昨日のタスク未達により、評価が大きく低下しています。[p]
...
#モノローグ
ミナからの通知だ。以前はあんなに輝いていた彼女の顔には、深い疲労の影が差している。[p]
目の下のクマをコンシーラーで隠しきれていない。[p]
それでも、彼女の承認は、僕のスコアの健全性を測る唯一のバロメーターだ。[p]
...
#ミナ
「そういえば、今日の強制タスクって、もう終わった？ 私、まだなの。[p]
...
[else]
    #モノローグ
    ミナからのメッセージは、単なる疲労のサインだろう。僕には関係ない。[p]
...
*T2_3
#モノローグ
深夜4時。瞼が重い。徹夜が続いている。頭の中に霧がかかったようだ。[p]
...
#モノローグ
真実はどこにある？ ネットの深層に、taskyの開発者に関する噂があった。[p]
「カナエ」という名前。[p]
taskyは猛烈に警告を発しているが、僕はその裏側で、開発者の一人だったとされるカナエに関する断片的なデータを見つけた。[p]
...
#モノローグ
taskyに頼っては意味がない。暗号を自力で解読する。……解けた。[p]
古いカフェの座標だ。[p]
[jump target="*T2_4_HIDE"]

*T2_4_HIDE
#tasky
警告。ユーザーは現在、非推奨エリアへの移動を計画しています。[p]
...
#モノローグ
彼女はそれだけ言うと、僕に助けを求める機会も与えず、静かに店を出ていった。[p]
