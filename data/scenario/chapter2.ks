...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/数週間が過ぎた。だが、最初の頃に感じた強烈な快感は、もうどこにもない.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/あるのは、「スコアを維持しなければならない」という強迫観念だけだ.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/tasky の通知音も、どこか鈍い、耳障りな音に変わっている気がした。これは本当に僕が求めていた「変化」なのか？.mp3" buf=1]
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="tasky/警告レベル1：ドーパミン受容体の感度低下を検知。.mp3" buf=1]
#tasky
警告レベル1：ドーパミン受容体の感度低下を検知。[p]


; Taskyボイス
[stopse buf=1]
; ★リスト一致確認済
[playse storage="tasky/本日の報酬設定を『小さな満足』に変更しました。サボることを許容しますか？.mp3" buf=1]
#tasky
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/目を閉じても、瞼の裏にはタスクリストのチェックマークが焼き付いている。強迫的なリズムが鼓動と重なる.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="tasky/あなたの価値が失効します。...無駄な時間を過ごすことを選択しますか？.mp3" buf=1]
#tasky
あなたの価値が失効します。[r]
...
[stopse buf=1]
; ★リスト完全一致
[playse storage="narrator/均されたはずの情報層に生じた歪みを是正するため、補正処理に向かった.mp3" buf=1]
#モノローグ
均されたはずの情報層に生じた歪みを是正するため、補正処理に向かった[p]
...
[stopse buf=1]
; ★リスト完全一致
[playse storage="narrator/taskyは猛烈に警告を発しているが、僕はその裏側で、開発者の一人「救済を求める者へ」と書いてある.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト完全一致
[playse storage="hero/あ、あなたはカナエさん？ taskyの開発者の一人だと.mp3" buf=1]
#主人公
...
「tasky？ ……ああ。...あれはね、人間が最も逃げたいと思うもの、つまり『空虚な時間』と『自己否定』を燃料に動く、完璧なエンジンよ」[p]
...
#カナエ
「あなたも、そのエンジンに燃やされそうになっている一人ね。顔を見ればわかる。...魂が削れている」[p]

; 主人公ボイス
[stopse buf=1]
; ★リスト完全一致
[playse storage="hero/でも、僕は変わりたかったんです。もっとマシな人間に.mp3" buf=1]
#主人公
(息をのむ)[r]
