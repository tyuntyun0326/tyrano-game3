...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/数週間が過ぎた。...あるのは、『スコアを維持しなければならない』という強迫観念だけだ。.mp3" buf=1]
#モノローグ
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="tasky/警告レベル 1：ドーパミン受容体の感度低下を検知。...本日の報酬設定を『小さな満足』に変更しました。.mp3" buf=1]
#tasky
...
#カナエ
あなたも、そのエンジンに燃やされそうになっている一人ね。...魂が削れている[p]

; 主人公ボイス
[stopse buf=1]
; ★リスト完全一致
[playse storage="hero/.mp3" buf=1]
#主人公
(息をのむ)[r]
...
#カナエ
変わるのと、支配されるのは違うわ。...あなたの安全のためにもね[p]
