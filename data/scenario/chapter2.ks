...
#モノローグ
taskyの通知音も、どこか鈍い、耳障りな音に変わっている。[l][r]
...
[if exp="f.f_dep > f.f_fat"]
    ...
    この苦痛こそが、僕を他人より優れた存在にするための通過儀礼なのだ。[l][r]
    凡人はここで脱落するが、僕は違う。taskyは僕を裏切らない。[l][r]
    この先に、さらなる高みが待っているはずだ。[p]
[elsif exp="f.f_fat > f.f_dep"]
    #モノローグ
    (疲弊型脱落予備軍ルート)[l][r]
    疲れている。体が鉛のように重い。指一本動かすのも億劫だ。しかし、やめられない。[l][r]
    ここでやめたら、これまで積み上げてきた記録（ストリーク）が全て無駄になる。[l][r]
...
[else]
    ...
    僕はシステムに使われない。この無意味な義務に、従う必要はない。[l][r]
...
本当は一日中布団の中にいた。疲れているのに、笑顔の絵文字を貼り付ける。[l][r]
誰も僕の本当の疲労を知らない。[p]
#tasky
...
#モノローグ
ミナからの通知だ。以前はあんなに輝いていた彼女の顔には、深い疲労の影が差している。[l][r]
目の下のクマをコンシーラーで隠しきれていない。[l][r]
...
; ★修正：チャット画面 (bg_smartphone_task_done.jpg)
...
もう指が動かない。お願い、今日の夜間タスク、代わりにやってくれない?[l][r]
...
満足感と共に、内臓がねじ切れるような深い疲労を感じる。[l][r]
...
それでも、タスクを放棄するという選択肢は、自己否定に直結する。[l][r]
