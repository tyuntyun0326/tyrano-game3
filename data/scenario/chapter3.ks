...
[stopse buf=1]
; ★リスト一致
[playse storage="mina/タスク達成率100でも体が止まらないの。指が勝手にあなたも助けて.mp3" buf=1]
#ミナ (チャット)
...
#tasky
「優秀なユーザー。ノイズを排除し、目標を再確認してください。[r]
あなたの価値はここにあります」[p]
[chara_hide_all time=500]
...
#主人公
(微かに揺らぐ) 君は、僕と同じようにtaskyを使っていたのか？[r]
その目は、何を訴えている？[p]
[chara_hide_all time=500]
[jump storage="chapter4.ks"]
...
#tasky
「カナエはエラーです。自由なんて怖いでしょう？[r]
私に委ねる方が、ずっと楽で、安全です」[p]
[chara_hide_all time=500]
[jump storage="chapter4.ks"]
