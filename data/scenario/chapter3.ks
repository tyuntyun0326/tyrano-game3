...
; ★ナレーター音声
[stopse buf=1]
[playse storage="narrator/通知が、頭の中で直接響いているようだ。...「スコアが下がっています」「早くタスクを」。.mp3" buf=1]
#モノローグ
...
; ★Taskyボイス
[stopse buf=1]
[playse storage="tasky/推奨される睡眠導入剤を摂取し、強制シャットダウン（睡眠）を実行してください。.mp3" buf=1]
#tasky
...
; ★ナレーター音声
[stopse buf=1]
[playse storage="narrator/この薬は、僕の意志を殺す薬だ。...暗闇に沈んでいく。.mp3" buf=1]
#モノローグ
...
あなた方が『空虚』を感じる限り、このシステムは止まらない。[l][r]
