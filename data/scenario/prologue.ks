...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/これが、最後のチャンスかもしれない。藁にもすがる思いで、震える指先をマウスに伸ばす。僕はtaskyに、僕の人生の主導権を委ねてみようと決めた。.mp3" buf=1]
#モノローグ
これが、最後のチャンスかもしれない。[r]
藁にもすがる思いで、震える指先をマウスに伸ばす。[r]
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="tasky/あなたの無駄を削ぎ落とし、幸福への最短ルートを計算します。初回起動タスク：「自己紹介の承認」を認識しました。個人端末を同期します。完了してください。.mp3" buf=1]
#tasky
あなたの無駄を削ぎ落とし、幸福への最短ルートを計算します。[r]
初回起動タスク：『自己紹介の承認』を認識しました。個人端末を同期します。完了してください。[p]
[stopse buf=1]
...
[stopse buf=1]
; ★リスト一致確認済
[playse storage="narrator/「承認ボタン」をクリックした瞬間、全身が電流に打たれたように痺れ、そして同時に重荷が消え去ったような浮遊感を覚えた。.mp3" buf=1]
#モノローグ
「承認」ボタンをクリックした瞬間、全身が電流に打たれたように痺れ、[r]
