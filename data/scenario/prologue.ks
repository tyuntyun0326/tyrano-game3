...
;=========================================
; メッセージ枠の表示（黒の半透明）
[position layer="message0" left=20 top=400 width=1240 height=300 page=fore visible=true color="black" opacity=180]
...
; 名前欄の設定
[ptext name="chara_name_area" layer="message0" color="0xffff00" size=28 x=40 y=410 bold="bold"]
...
#tasky (広告音声)
『まだ、迷っているのですか？ あなたの内なる可能性を引き出し、埋もれた努力を数値で証明します。[p]
自己管理AIアプリ『tasky』。[p]
